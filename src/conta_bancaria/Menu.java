...
public class Menu {
	...
	while (true) {
		...
		case 3:
			...
			procurarContaPorNumero(); //responsavel por localizar o número da conta
	...
	private static void procurarContaPorNumero() {
		...
		// lê um número inteiro corretamente
	    int numero = leia.nextInt();
	    // limpa o enter do teclado (boa prática)
	    leia.nextLine();
	...
	private static void atualizarConta() {
		...
		if(conta != null) {
			...
			String titular = conta.getTitulo();
